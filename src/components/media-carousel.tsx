...
function MediaCarousel({ title, slides, options }: MediaCarouselProps) {
	...
	return (
		...
		>
			...
			<Carousel
				className='[&>div[role="listbox"]]:before:from-bg [&>div[role="listbox"]]:after:from-bg relative mb-4 w-full lg:mb-0 [&>div[role="listbox"]]:relative [&>div[role="listbox"]]:before:absolute [&>div[role="listbox"]]:before:top-0 [&>div[role="listbox"]]:before:-right-0.5 [&>div[role="listbox"]]:before:z-1 [&>div[role="listbox"]]:before:h-full [&>div[role="listbox"]]:before:w-24 [&>div[role="listbox"]]:before:bg-gradient-to-l [&>div[role="listbox"]]:before:opacity-100 [&>div[role="listbox"]]:before:transition-opacity [&>div[role="listbox"]]:before:duration-300 [&>div[role="listbox"]]:not-data-[gradient-right]:before:pointer-events-none [&>div[role="listbox"]]:not-data-[gradient-right]:before:opacity-0 [&>div[role="listbox"]]:after:absolute [&>div[role="listbox"]]:after:top-0 [&>div[role="listbox"]]:after:-left-0.5 [&>div[role="listbox"]]:after:z-1 [&>div[role="listbox"]]:after:h-full [&>div[role="listbox"]]:after:w-24 [&>div[role="listbox"]]:after:bg-gradient-to-r [&>div[role="listbox"]]:after:opacity-100 [&>div[role="listbox"]]:after:transition-opacity [&>div[role="listbox"]]:after:duration-300 [&>div[role="listbox"]]:not-data-[gradient-left]:after:pointer-events-none [&>div[role="listbox"]]:not-data-[gradient-left]:after:opacity-0 data-[initializing]:[&>div[role="listbox"]]:before:opacity-100 [&>div[role="listbox"]]:before:sm:w-32 [&>div[role="listbox"]]:after:sm:w-32'
				opts={{
					skipSnaps: true,
					slidesToScroll: 2,
